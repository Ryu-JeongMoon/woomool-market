...
public class ImageProcessor {
    ...
    public List<Image> parse(List<MultipartFile> files) {
        ...
        for (MultipartFile multipartFile : files) {
            ...
            try {
                ...
                throw new IllegalStateException(ExceptionConstant.IMAGE_CANNOT_TRANSFER);
            }
    ...
    private void checkFileExistence(File file) {
        if (!file.exists()) {
            ...
            if (!wasSuccessful) {
                ...
                throw new IllegalStateException(ExceptionConstant.IMAGE_FOLDER_NOT_FOUND);
            }
        }
    }
    ...
    private void checkFileExtension(MultipartFile multipartFile, String contentType) {
        if (!StringUtils.hasText(contentType)) {
            ...
            throw new IllegalArgumentException(ExceptionConstant.IMAGE_NOT_PROPER_EXTENSION);
        }
    }
