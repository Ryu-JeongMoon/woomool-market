...
class MemberQueryResponseTest extends AbstractDataJpaTest {
  ...
  void conversionOf() {
    ...
    assertThat(memberQueryResponse.getRole()).isEqualTo(member.getRole());
    assertThat(memberQueryResponse.getAuthProvider()).isEqualTo(member.getInitialAuthProvider());
    assertThat(memberQueryResponse.getProfileImage()).isEqualTo(member.getProfileImage());
    assertThat(memberQueryResponse.getLeaveDateTime()).isEqualTo(member.getLeftAt());
