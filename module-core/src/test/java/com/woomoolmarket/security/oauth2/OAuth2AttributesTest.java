...
class OAuth2AttributesTest {
    ...
    private static String REGISTRATION_ID = "facebook";
    private static String NAME_ATTRIBUTE_KEY = "panda-attribute-key";
    private static String USERNAME_ATTRIBUTE_NAME = "panda-attribute-name";
    private static String NICKNAME = "panda-nickname";
    private static String EMAIL = "panda-email";
    private static String PROFILE_IMAGE = "panda-image";
