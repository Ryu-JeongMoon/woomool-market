...
public class ExceptionConstants {
  ...
  public static final String TOKEN_NOT_VALID = "유효하지 않은 토큰입니다";
  public static final String ACCESS_TOKEN_NOT_VALID = "유효하지 않은 Access 토큰입니다";
  public static final String REFRESH_TOKEN_NOT_VALID = "유효하지 않은 Refresh 토큰입니다";
